...
MapSpriteSets:
	...
	db SPRITESET_PEWTER_ONLY     ; PEWTER_CITY
	...
	db SPRITESET_PEWTER_ONLY     ; ROUTE_3
...
SplitMapSpriteSets:
	table_width 4
	db NORTH_SOUTH, 37, SPRITESET_PEWTER_ONLY, SPRITESET_PALLET_VIRIDIAN     ; SPLITSET_ROUTE_2
...
; SPRITESET_VERMILION
	...
	db SPRITE_GAMBLER
	db SPRITE_MACHOP
	db SPRITE_ENGINEER ; to replace with Engineer
	db SPRITE_SAILOR
	db SPRITE_JR_TRAINER_F
	db SPRITE_COOLTRAINER_M
	db SPRITE_POKE_BALL
