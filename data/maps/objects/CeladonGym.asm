...
CeladonGym_Object:
	...
	object_event  9,  5, SPRITE_JR_TRAINER_F, STAY, DOWN, TEXT_CELADONGYM_COOLTRAINER_F2, OPP_JR_TRAINER_F, 11
	...
	object_event  5,  3, SPRITE_COOLTRAINER_F_REAL, STAY, DOWN, TEXT_CELADONGYM_COOLTRAINER_F4, OPP_COOLTRAINER_F, 1
