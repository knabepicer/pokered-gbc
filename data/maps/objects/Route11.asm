...
Route11_Object:
	...
	object_event 36, 11, SPRITE_ENGINEER, STAY, DOWN, TEXT_ROUTE11_SUPER_NERD1, OPP_ENGINEER, 2
	...
	object_event 45, 16, SPRITE_ENGINEER, STAY, LEFT, TEXT_ROUTE11_SUPER_NERD2, OPP_ENGINEER, 3
