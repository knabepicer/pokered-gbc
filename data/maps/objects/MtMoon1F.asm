...
MtMoon1F_Object:
	...
	object_event  7, 22, SPRITE_BUG_CATCHER, STAY, DOWN, TEXT_MTMOON1F_YOUNGSTER2, OPP_BUG_CATCHER, 7
	object_event 30, 27, SPRITE_BUG_CATCHER, STAY, RIGHT, TEXT_MTMOON1F_YOUNGSTER3, OPP_BUG_CATCHER, 8
