...
Route3_Object:
	...
	object_event 10,  6, SPRITE_BUG_CATCHER, STAY, RIGHT, TEXT_ROUTE3_YOUNGSTER1, OPP_BUG_CATCHER, 4
	...
	object_event 19,  5, SPRITE_BUG_CATCHER, STAY, DOWN, TEXT_ROUTE3_YOUNGSTER3, OPP_BUG_CATCHER, 5
	...
	object_event 24,  6, SPRITE_BUG_CATCHER, STAY, RIGHT, TEXT_ROUTE3_YOUNGSTER5, OPP_BUG_CATCHER, 6
