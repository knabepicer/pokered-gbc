...
Route15_Object:
	...
	def_object_events
	object_event 41, 11, SPRITE_JR_TRAINER_F, STAY, DOWN, TEXT_ROUTE15_COOLTRAINER_F1, OPP_JR_TRAINER_F, 20
	object_event 53, 10, SPRITE_JR_TRAINER_F, STAY, LEFT, TEXT_ROUTE15_COOLTRAINER_F2, OPP_JR_TRAINER_F, 21
	...
	object_event 37,  5, SPRITE_JR_TRAINER_F, STAY, RIGHT, TEXT_ROUTE15_COOLTRAINER_F3, OPP_JR_TRAINER_F, 22
	object_event 18, 13, SPRITE_JR_TRAINER_F, STAY, UP, TEXT_ROUTE15_COOLTRAINER_F4, OPP_JR_TRAINER_F, 23
