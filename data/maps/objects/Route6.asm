...
Route6_Object:
	...
	object_event 11, 21, SPRITE_JR_TRAINER_F, STAY, LEFT, TEXT_ROUTE6_COOLTRAINER_F1, OPP_JR_TRAINER_F, 2
	...
	object_event 11, 30, SPRITE_JR_TRAINER_F, STAY, LEFT, TEXT_ROUTE6_COOLTRAINER_F2, OPP_JR_TRAINER_F, 3
