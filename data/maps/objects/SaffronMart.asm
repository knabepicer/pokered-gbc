...
SaffronMart_Object:
	...
	object_event  4,  2, SPRITE_SUPER_NERD_REAL, STAY, NONE, TEXT_SAFFRONMART_SUPER_NERD
	object_event  6,  5, SPRITE_COOLTRAINER_F_REAL, WALK, ANY_DIR, TEXT_SAFFRONMART_COOLTRAINER_F
