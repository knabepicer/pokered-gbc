...
FuchsiaCity_Object:
	...
	def_object_events
	object_event 10, 12, SPRITE_COOLTRAINER_M, WALK, LEFT_RIGHT, TEXT_FUCHSIACITY_YOUNGSTER1
	object_event 28, 17, SPRITE_COOLTRAINER_M_REAL, WALK, LEFT_RIGHT, TEXT_FUCHSIACITY_GAMBLER
	object_event 30, 14, SPRITE_FISHER, STAY, DOWN, TEXT_FUCHSIACITY_ERIK
	object_event 24,  8, SPRITE_BIRDKEEPER, STAY, UP, TEXT_FUCHSIACITY_YOUNGSTER2
