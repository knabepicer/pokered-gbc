...
ViridianForest_Object:
	...
	def_object_events
	object_event 16, 43, SPRITE_BUG_CATCHER, STAY, NONE, TEXT_VIRIDIANFOREST_YOUNGSTER1
	...
	object_event 27, 40, SPRITE_BUG_CATCHER, STAY, NONE, TEXT_VIRIDIANFOREST_YOUNGSTER5
