...
; Route 6
	...
	db 16, PIDGEY, SQUIRTLE, JIGGLYPUFF, 0
; Unused
	db 22, BULBASAUR, 0
; Route 9
	db 18, ODDISH, BELLSPROUT, ODDISH, BELLSPROUT, 0
...
; Route 13
	db 24, PIDGEY, BUTTERFREE, EEVEE, PIKACHU, MEOWTH, 0
	db 30, FLAREON, JOLTEON, VAPOREON, 0
	db 27, DODUO, MEOWTH, EEVEE, PIDGEOTTO, 0
...
; Rock Tunnel 1F
	...
	db 19, PIDGEY, RATTATA, MEOWTH, BELLSPROUT, 0
; Route 15
	db 28, GLOOM, BUTTERFREE, ODDISH, 0
...
; Rock Tunnel B1F
	db 20, SLOWPOKE, OMANYTE, KABUTO, 0
...
BikerData:
; Route 13
	db 28, KOFFING, KOFFING, PINSIR, 0
; Route 14
	db 29, KOFFING, GRIMER, 0
; Route 15
	db 25, KOFFING, BEEDRILL, WEEZING, KOFFING, GRIMER, 0
	db 28, KOFFING, GRIMER, WEEZING, 0
; Route 16
	db 29, GRIMER, KOFFING, 0
	db 33, SCYTHER, 0
	db 27, GRIMER, BEEDRILL, GRIMER, VENOMOTH, 0
; Route 17
	...
	db 28, WEEZING, BEEDRILL, WEEZING, 0
	db 33, MUK, 0
	db 29, VOLTORB, VOLTORB, 0
	db 29, WEEZING, MUK, 0
	db 25, BEEDRILL, WEEZING, KOFFING, KOFFING, VENOMOTH, 0
; Route 14
	db 26, KOFFING, BEEDRILL, GRIMER, KOFFING, 0
	db 28, GRIMER, IVYSAUR, KOFFING, 0
	db 29, KOFFING, MUK, 0
...
MrFujiData:
	db $FF, 60, KANGASKHAN, 60, GENGAR, 64, PORYGON, 63, KABUTOPS, 63, MAGMAR, 66, MAROWAK, 0
...
; Route 19
	...
	db 27, HORSEA, TENTACOOL, KRABBY, GOLDEEN, 0
	db 29, GOLDEEN, SHELLDER, SEAKING, 0
	db 30, HORSEA, HORSEA, 0
	db 27, TENTACOOL, KRABBY, STARYU, HORSEA, TENTACRUEL, 0
; Route 20
	db 31, SHELLDER, CLOYSTER, 0
	db 35, LAPRAS, 0
	db 28, KRABBY, HORSEA, SEADRA, HORSEA, 0
; Route 21
...
; Silph Co. 4F
	db 33, ELECTRODE, 0
; Silph Co. 5F
	db 26, MAGNETON, DITTO, WEEZING, MAGNEMITE, 0
; Silph Co. 6F
...
; Silph Co. 9F
	db 28, VOLTORB, PORYGON, MAGNETON, 0
; Silph Co. 10F
...
; Rocket Hideout B1F
	...
	db 20, GRIMER, GROWLITHE, KOFFING, 0
	db 19, GROWLITHE, RATICATE, RATICATE, RATTATA, 0
	db 22, GRIMER, KOFFING, 0
; Rocket Hideout B2F
	db 17, ZUBAT, KOFFING, GRIMER, ZUBAT, RATICATE, 0
; Rocket Hideout B3F
	db 20, RATTATA, BEEDRILL, DROWZEE, 0
...
; Silph Co. 2F
	...
	db 25, GOLBAT, GROWLITHE, PARAS, RATICATE, ZUBAT, 0
; Silph Co. 3F
	db 28, PARASECT, HYPNO, RATICATE, 0
; Silph Co. 4F
...
; Silph Co. 6F
	db 29, MACHOP, MACHOKE, 0
	db 28, ZUBAT, PARAS, GOLBAT, 0
; Silph Co. 7F
	db 26, RATICATE, ARBOK, KOFFING, GOLBAT, 0
	db 29, CUBONE, PINSIR, 0
	db 29, SCYTHER, SANDSLASH, 0
; Silph Co. 8F
...
; Silph Co. 10F
	db 33, ARCANINE, 0
; Silph Co. 11F
	db 25, PARAS, GROWLITHE, ZUBAT, RATTATA, EKANS, 0
...
; Victory Road 3F
	db 43, ELECTABUZZ, JYNX, MAGMAR, 0
	db 43, SCYTHER, DEWGONG, CHANSEY, 0
; Unused
...
BrockData:
	...
	db $FF, 64, KABUTOPS, 64, OMASTAR, 64, RHYDON, 64, AERODACTYL, 65, GOLEM, 66, ONIX, 0

MistyData:
	db $FF, 18, STARYU, 21, STARMIE, 0
	db $FF, 64, SEAKING, 64, KINGLER, 64, GYARADOS, 65, GOLDUCK, 65, VAPOREON, 66, STARMIE, 0

LtSurgeData:
	db $FF, 21, VOLTORB, 18, PIKACHU, 24, RAICHU, 0
	;first raichu is the meme one with surf/fly
	db $FF, 65, MAGNETON, 65, RAICHU, 65, ELECTABUZZ, 65, JOLTEON, 66, ELECTRODE, 66, RAICHU, 0

ErikaData:
	db $FF, 29, VICTREEBEL, 24, TANGELA, 29, VILEPLUME, 0
	db $FF, 65, TANGELA, 65, PARASECT, 66, EXEGGUTOR, 66, VENUSAUR, 66, VICTREEBEL, 67, VILEPLUME

KogaData:
	db $FF, 37, KOFFING, 39, MUK, 38, VENOMOTH, 43, WEEZING, 0
	db $FF, 66, BEEDRILL, 66, GOLBAT, 66, TENTACRUEL, 66, MUK, 67, VENOMOTH, 67, WEEZING

BlaineData:
	db $FF, 42, NINETALES, 40, PONYTA, 42, RAPIDASH, 47, ARCANINE, 0
	db $FF, 67, FLAREON, 67, MAGMAR, 67, CHARIZARD, 68, RAPIDASH, 68, NINETALES, 68, ARCANINE

SabrinaData:
	db $FF, 38, KADABRA, 37, MR_MIME, 38, JYNX, 43, ALAKAZAM, 0
	db $FF, 66, SLOWBRO, 66, HYPNO, 67, JYNX, 67, EXEGGUTOR, 67, MR_MIME, 68, ALAKAZAM
