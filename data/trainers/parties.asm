...
; Route 13
	db 24, PIDGEY, MEOWTH, EEVEE, PIKACHU, MEOWTH, 0
	db 30, POLIWAG, POLIWAG, 0
	db 27, PIDGEY, MEOWTH, EEVEE, PIDGEOTTO, 0
...
MistyData:
	...
	db $FF, 64, SEAKING, 64, TENTACRUEL, 64, GYARADOS, 65, GOLDUCK, 65, VAPOREON, 66, STARMIE, 0

LtSurgeData:
	db $FF, 21, VOLTORB, 18, PIKACHU, 24, RAICHU, 0
	;first raichu is the meme one with surf/fly
	db $FF, 65, MAGNETON, 65, RAICHU, 65, ELECTABUZZ, 65, JOLTEON, 66, MAGNETON, 66, RAICHU, 0
