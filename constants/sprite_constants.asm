...
; SpriteSheetPointerTable indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_KOGA_NEW
	const SPRITE_BLAINE	 
	const SPRITE_SEEL_ACTUAL
	...
	const SPRITE_COOLTRAINER_F_REAL
	const SPRITE_COOLTRAINER_M_REAL
	const SPRITE_TAMER
	const SPRITE_BURGLAR
	const SPRITE_JUGGLER
	const SPRITE_CUEBALL
	const SPRITE_JR_TRAINER_F
	const SPRITE_ENGINEER
	const SPRITE_SUPER_NERD_REAL
	const SPRITE_POKEMANIAC
	const SPRITE_BIRDKEEPER
